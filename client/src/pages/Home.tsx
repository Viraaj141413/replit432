        ...
        <div className="container max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex h-20 items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="relative flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 shadow-xl shadow-blue-500/30 transform hover:scale-110 transition-transform duration-300">
                <Bell className="h-7 w-7 text-white" />
                <div className="absolute -right-1.5 -top-1.5 h-4 w-4 rounded-full bg-gradient-to-br from-green-400 to-green-500 ring-2 ring-white dark:ring-slate-950 animate-pulse" />
              </div>
              <div>
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="hidden md:flex items-center gap-3 px-5 py-2.5 rounded-xl bg-gradient-to-r from-white to-blue-50 dark:from-slate-800 dark:to-slate-700 border border-slate-200 dark:border-slate-700 shadow-md">
                <div className="flex items-center gap-2">
                  <div className="h-2.5 w-2.5 rounded-full bg-blue-500 animate-pulse shadow-lg shadow-blue-500/50" />
                  <span className="text-sm font-bold text-slate-900 dark:text-white">{activeReminders.length}</span>
                ...
                {overdueReminders.length > 0 && (
                  <>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-bold text-red-600 dark:text-red-400">{overdueReminders.length}</span>
                      <span className="text-sm text-slate-600 dark:text-slate-400 font-medium">Overdue</span>
                    </div>
                  </>
                )}
              </div>
              <Button
                ...
                size="lg"
                className="gap-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-purple-500/40 transform hover:scale-105 transition-all duration-200"
                data-testid="button-create-reminder"
              >
                <Plus className="h-5 w-5" />
                <span className="hidden sm:inline font-bold">New Reminder</span>
                <span className="sm:hidden font-bold">New</span>
              </Button>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon" className="h-12 w-12 rounded-full hover:scale-110 transition-transform duration-200">
                    <Avatar className="h-10 w-10 ring-2 ring-blue-500/20">
                      <AvatarFallback className="bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 text-white font-bold text-base shadow-lg">
      ...
      <main className="container max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="mb-10 space-y-3">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Manage Your Reminders</h2>
          </div>
          <p className="text-sm text-slate-600 dark:text-slate-400 font-medium">
            Schedule QA tasks and receive automated SMS notifications when they're due
          </p>
        </div>

        <Tabs defaultValue="active" className="space-y-8">
          <TabsList className="grid w-full max-w-2xl grid-cols-4 h-14 p-1.5 bg-gradient-to-r from-white to-blue-50 dark:from-slate-900 dark:to-indigo-950 border border-slate-200 dark:border-slate-800 shadow-lg" data-testid="tabs-reminder-filter">
            ...
            <TabsTrigger value="analytics" className="gap-2 data-[state=active]:shadow-md" data-testid="tab-analytics">
              <span>Analytics</span>
            </TabsTrigger>
          </TabsList>
